#
#  Be sure to run `pod spec lint DTImageScrollView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Daron Tancharoen"
  # s.authors            = { "Daron Tancharoen" => "daront@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Daron Tancharoen"
  ...
  s.dependency 'AlamofireImage', '~> 2.4.1'
